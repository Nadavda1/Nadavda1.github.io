...
{
	Product* pPro1 = (Product*)p1;
	Product* pPro2 = (Product*)p2;
	return strcmp(pPro1->barcode, pPro2->barcode);
...
{
	if (fwrite(pP, sizeof(Product), 1, fp) != 1)
		return 0;
	return 1;
}
...
{
	if (fread(pP, sizeof(Product), 1, fp) != 1)
		return 0;
	return 1;
}
